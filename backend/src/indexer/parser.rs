...
/// Stellar address claims a XoXoPay username on-chain.
...
pub fn parse_xoxopay_event(topic: &str, value: &Value) -> XoXoPayEvent {
    match topic {
        "YieldDeposited" => {
            ...
            XoXoPayEvent::YieldDeposited(YieldDepositedEvent {
                address,
                amount,
                tx_hash,
            })
        ...
        "YieldWithdrawn" => {
            ...
            XoXoPayEvent::YieldWithdrawn(YieldWithdrawnEvent {
                address,
                amount,
                tx_hash,
            })
        ...
        "YieldRateUpdated" => {
            ...
            XoXoPayEvent::YieldRateUpdated(YieldRateUpdatedEvent { apy, tx_hash })
        }
        "YieldAccrued" => {
            ...
            XoXoPayEvent::YieldAccrued(YieldAccruedEvent {
                elapsed_ledgers,
                added_yield,
                new_index,
                tx_hash,
        ...
        "TokenSalvaged" => {
            ...
            XoXoPayEvent::TokenSalvaged(TokenSalvagedEvent {
                salvager,
                token,
                recipient,
                amount,
        ...
        "FriendAdded" => {
            ...
            let tx_hash = extract_tx_hash(value);
            XoXoPayEvent::FriendAdded(FriendAddedEvent {
        ...
        "FriendRemoved" => {
            let (a1, a2) = extract_vec_address_pair(value);
            let tx_hash = extract_tx_hash(value);
            XoXoPayEvent::FriendRemoved(FriendRemovedEvent {
        ...
        "YieldAccrued" => {
            ...
            XoXoPayEvent::YieldAccrued(YieldAccruedEvent { added_yield, elapsed_ledgers, new_index, tx_hash })
        }
        ...
        "UserRegistered" => {
            ...
            XoXoPayEvent::UserRegistered(UserRegisteredEvent { address, username, tx_hash })
        }
        _ => XoXoPayEvent::Unknown,
    }
}
...
mod tests {
    ...
    fn parses_yield_accrued_payload() {
        ...
        match parse_xoxopay_event("YieldAccrued", &payload) {
            XoXoPayEvent::YieldAccrued(event) => {
    ...
    fn parses_friend_added_event() {
        ...
        match parse_xoxopay_event("FriendAdded", &payload) {
            XoXoPayEvent::FriendAdded(event) => {
    ...
    fn parses_friend_removed_event() {
        ...
        match parse_xoxopay_event("FriendRemoved", &payload) {
            XoXoPayEvent::FriendRemoved(event) => {

...
const DEFAULT_QUEUE: &str = "xoxopay:jobs:queue";
const PROCESSING_QUEUE: &str = "xoxopay:jobs:processing";
const DEAD_LETTER_QUEUE: &str = "xoxopay:jobs:dead_letter";
const RETRY_QUEUE: &str = "xoxopay:jobs:retry";

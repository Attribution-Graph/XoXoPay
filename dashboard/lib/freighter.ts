...
export const FREIGHTER_MOCK_KEY = "__xoxopayFreighterApiMock__";

/**
 * Resolve the Freighter API.
 *
 * Freighter is a browser extension, so end-to-end tests have no way to install
 * or drive it. When `window.__xoxopayFreighterApiMock__` is present the module
 ...
 */
export const WALLET_SESSION_KEY = "xoxopay.wallet.connected";

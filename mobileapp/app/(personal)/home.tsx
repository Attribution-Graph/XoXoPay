  ...
  return (
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <View style={styles.header}>
        <Text style={styles.logo}>xoxopay</Text>
              ...
              <View style={styles.autoEarnModalRule}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.autoEarnModalRuleDesc}>
                    Any idle balance in your XoXoPay wallet is automatically swept
              ...
              <View style={styles.autoEarnModalRule}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.autoEarnModalRuleDesc}>
                    ...
                    setting on and XoXoPay handles the rest — no wallets, seeds, or

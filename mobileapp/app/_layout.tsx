...
const IOS_STORE_URL = "https://apps.apple.com/app/xoxopay";
const ANDROID_STORE_URL =
  "https://play.google.com/store/apps/details?id=app.xoxopay";
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <Stack.Screen name="about-xoxopay" options={{ animation: "fade" }} />
        ...
        <View style={updateStyles.overlay}>
          <View style={updateStyles.card}>
            ...
            <Text style={updateStyles.body}>
              A newer version of XOXOPAY is required to continue. Please update

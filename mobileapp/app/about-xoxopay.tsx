...
export default function AboutXoXoPayScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>About XoXoPay</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      >
        ...
        <View style={styles.heroSection}>
          <Text style={styles.heroTitle}>XoXoPay</Text>
          <Text style={styles.heroSubtitle}>Fast. Secure. Seamless.</Text>
          <Text style={styles.heroDescription}>
            XoXoPay is a next-generation payment and transfer platform designed to
            make moving money as easy as sending a message. Whether you're a
            user sending funds to friends or a merchant accepting payments, XoXoPay
        ...
        <Section title="How It Works" icon="settings-outline">
          XoXoPay leverages advanced blockchain technology to ensure near-instant
          settlements. Simply scan a QR code, enter a XoXoPay ID, or tap to pay.
        ...
        >
          Security is at the heart of everything we do. XoXoPay uses
        ...
        <View style={styles.ctaCard}>
          ...
          <Text style={styles.ctaText}>
            Join thousands of users and merchants already using XoXoPay for their
            daily transactions.
          </Text>
          <TouchableOpacity
          ...
          >
            <Text style={styles.ctaButtonText}>Create a XoXoPay</Text>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            © 2026 XoXoPay. All rights reserved.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>

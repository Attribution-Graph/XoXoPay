...
export default function ReceiveScreen() {
  ...
  const handleShare = async () => {
    try {
      await Share.share({
        message: receiveType === "xoxopay" ? blinksId : walletAddress,
      });
    } catch (error) {
      console.log(error);
    }
  ...
  const renderStep0 = () => (
    <View style={styles.stepContainer}>
      ...
      <View style={styles.cardsContainer}>
        <AccountTypeCard
          title="Blinx User"
          description="Receive instantly from any Blinx user via your XoXoPay ID"
          Icon={XoXoPayIcon}
        ...
        <View style={styles.idDisplaySection}>
          ...
          <View style={styles.idTextContainer}>
            <Text style={styles.idLabel}>
              {receiveType === "xoxopay" ? "Blinks ID" : "Wallet Address"}
            </Text>
            <Text style={styles.idValue}>
              {receiveType === "xoxopay" ? blinksId : walletAddress}
            </Text>
          </View>
        </View>

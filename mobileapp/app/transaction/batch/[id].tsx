  ...
  const handleExportReceipt = async () => {
    ...
    try {
      ...
      await Share.share({
        ...
        message: `XOXOPAY batch receipt #${summary.id}`,
      });
    } catch (e) {
      ...
      >
        <View style={styles.receiptCard}>
          <View style={styles.receiptHeader}>
            <Text style={styles.receiptBrand}>XOXOPAY</Text>
          ...
          <Text style={styles.receiptFooter}>Generated by XOXOPAY mobile app</Text>
        </View>
      </View>
    </SafeAreaView>
  );

...
const PRIVY_APP_ID =
  process.env.EXPO_PUBLIC_PRIVY_APP_ID || "clxoxopay_privy_app_id";
...
export function buildPrivyAuthUrl(
  ...
  return `https://auth.privy.io/apps/${PRIVY_APP_ID}/login?provider=${provider}&redirect_uri=xoxopay://privy-callback`;
}

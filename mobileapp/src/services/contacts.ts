 ...
 *     display name with the returned XoXoPay username / Stellar address.
 *
 * Usage:
 *   import { fetchMatchedContacts } from './contacts';
 *
 *   const matches = await fetchMatchedContacts();
 *   // [{ contactName: "Tolu O.", username: "tolu.xoxopay", address: "G..." }, …]
 */
...
export interface MatchedContact {
  ...
  contactName: string;
  /** XoXoPay username returned by the backend match. */
  username: string;
 ...
 * matching XoXoPay usernames / Stellar addresses.
 *

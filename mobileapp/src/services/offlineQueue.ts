 ...
 *
 * When the device loses connectivity, outgoing XoXoPay transaction requests are
 * persisted to AsyncStorage under `@xoxopay_offline_tx_queue`. A NetInfo listener
...
export const OFFLINE_QUEUE_KEY = "@xoxopay_offline_tx_queue";
...
export interface QueuedTransaction {
  ...
  id: string;
  /** Full API URL including base (e.g. https://api.xoxopay.app/api/v1/transfer). */
  endpoint: string;

...
This document outlines the specific areas of the XoXoPay architecture that require comprehensive penetration testing and auditing prior to Mainnet launch.

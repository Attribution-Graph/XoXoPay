/**
 * OpenAPI 3.0 specification for the XoXoPay (Blink) API.
 *
...
export const openApiSpec = {
    openapi: '3.0.3',
    info: {
        title: 'XoXoPay (Blink) API',
        version: '1.0.0',
        description: `
## Overview
XoXoPay is a Stellar-powered payments platform supporting merchant QR/NFC payments,
...
See the **Webhooks** section below for payload schemas.
        `.trim(),
        contact: { name: 'XoXoPay Support', email: 'support@xoxopay.app' },
        license: { name: 'MIT' },
    },
    servers: [
        { url: 'https://api.xoxopay.app/api/v1', description: 'Production' },
        { url: 'https://testnet.xoxopay.app/api/v1', description: 'Testnet' },
